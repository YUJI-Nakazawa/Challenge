<?php
const ROOT_URL = 'http://localhost/UserManagementSystem-ver2/app';     //indexディレクトリへのURL
...
const DELETE = 'delete.php';                        //削除ページ
const DELETE_RESULT = 'delete_result.php';          //削除結果ページ
const UPDATE = 'update.php';                        //変更ページ
const UPDATE_RESULT = 'update_result.php';          //変更結果ページ
